...
class Bg_Overworld:
	def __init__(self,horizon):
		self.top = pygame.image.load('graphics/decoration/bg/sky_top.png').convert()
		self.bottom = pygame.image.load('graphics/decoration/bg/sky_bottom.png').convert()
		self.middle = pygame.image.load('graphics/decoration/bg/sky_middle.png').convert()
		self.horizon = horizon
