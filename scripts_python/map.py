...
class MapManager:
    ...
    def __init__(self, screen, player):
        ...
        self.register_map("my_house", portals=[
            Portal(from_world="my_house", origin_point="exit_house", target_world="world", teleport_point="spawn_house_exit")
        ])
        self.register_map("new_world", portals=[
            Portal(from_world="new_world", origin_point="teleporter", target_world="world", teleport_point="spawn_player")
        ])
