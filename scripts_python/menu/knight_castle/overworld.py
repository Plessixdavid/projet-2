...
class Icon(pygame.sprite.Sprite):
    # Création de l'icon du personnage sur l'overworld
    def __init__(self,pos):
        super().__init__()
        self.pos = pos
        self.image = pygame.image.load('scripts_python/menu/knight_castle/graphics/character/idle/1.png').convert_alpha()
        self.rect = self.image.get_rect(center = pos) 
...
class Overworld:
    ...
    def run(self):
        ...
        image = pygame.image.load("scripts_python/menu/knight_castle/123.jpg")
