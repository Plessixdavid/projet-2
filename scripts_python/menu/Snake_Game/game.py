...
class Game4 :
    ...
    def __init__(self):
        ...
        # Charge image :
        self.image_head_snake = pygame.image.load('scripts_python/menu/Snake_Game/head_snake.png')
        self.image = pygame.image.load('scripts_python/menu/Snake_Game/snake-game.jpg')
        # Shrink the image :
