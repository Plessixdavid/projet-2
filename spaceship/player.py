...
class Player(pygame.sprite.Sprite):
    ...
    def __init__(self, game):
        ...
        self.image = pygame.image.load("spaceship/assets/ship.png")
    ...
    def update_level_bar(self,surface):
        ...
        pygame.draw.rect(surface, (187, 11, 11), [
            ...
            25])
        score_text = pygame.font.Font('spaceship/assets/FreckleFace-Regular.ttf', 40).render(f'Score: {self.total_xp}', True, (247, 255, 0 ))
